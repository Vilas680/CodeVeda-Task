...
Multiplication
Division
The program is beginner-friendly and works on the command line.
...
Improve logical thinking and Python basics
...
Calculator performs the selected operation
Result is displayed

If division by zero → error message shown
